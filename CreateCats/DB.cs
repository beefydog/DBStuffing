...
public class DB
{
    ...
    public static void Categories_Insert_Bulk(List<Category> cats)
    {
        ...
        try
        {
            copy.WriteToServer(ToDataTable(cats));
         }
        catch (Exception ex)
        {
    ...
    public static async Task Categories_Insert_Bulk_Async(List<Category> cats)
    {
        ...
        try
        {
          await copy.WriteToServerAsync(ToDataTable(cats));
        }
        catch (Exception ex)
        {
            LastErrorMsg = ex.Message;
    ...
    // general purpose method to create datatables from lists - uses reflection
